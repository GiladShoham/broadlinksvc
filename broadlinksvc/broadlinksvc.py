...
def execute_command(container):
  if 'redalert' in str(container):
    x = subprocess.check_output('wget https://img.wcdn.co.il/f_auto,w_300,t_54/2/9/7/1/2971604-46.jpg', shell = True)
    print(x)
